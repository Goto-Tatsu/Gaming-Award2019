...
public class sharp_Rleg : MonoBehaviour
{
    ...
    public sharp_Rleg_shrink Rleg_shrik;
    ...
    void Update()
    {
        ...
        //if (Cling == true)
        //{
        //    if (Rleg_shrik.Get_Shrink == false)
        //    {
        //        Fixat = 0;
        //    }
        //}
    ...
    void Fixation_Controller(int index)
    {
        ...
        {
            //コントーローラ
            if (player.Get_ControX() >= 0.5 && player.Get_ControX() <= 1 && player.Get_ControY() > 0 && player.Get_ControY() <= 1)
            {
                if (Fixat < max_range)
                {
                    Fixat += 0.5;
